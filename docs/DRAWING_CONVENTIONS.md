...
**두 전개는 같은 크기가 아니다.** 같은 기와를 펴도 바깥 벽은 축에서 벽 두께만큼 더 멀리 있으므로 재는 호가 그만큼 길다 — 정확히 (R + t) / R. 합성 암키와(R 210 mm, t 20 mm)에서 등면 전개 278.0 mm 대 내면 251.5 mm, 비율 1.0952이고 (210+20)/210 = 1.0952다. 한 장에 둘을 나란히 실으면 독자가 같은 면의 두 판으로 읽지 않도록 어느 쪽 벽인지 캡션이나 제목란이 말해야 한다.
