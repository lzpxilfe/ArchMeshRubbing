...
| 검사 | 결과 |
|---|---:|
| Python 3.12.13 `python -m pytest -q` | 399 passed, 113 subtests passed |
| 3-OS persistence-smoke 명시 suite의 로컬 실행 | 328 passed, 113 subtests passed |
