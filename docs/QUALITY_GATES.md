...
- 명시적 canonical 장축과 최대 250,000-face source selection을 고정하고 자동 fallback, 1 µm grid collapse, topology·duplicate/non-manifold/orientation, 전역 positive-area UV overlap, 3-edge·area·Jacobian singular-value distortion gate 실패를 READY record로 승격하지 않는 `surface.tile_unwrap.v1`
