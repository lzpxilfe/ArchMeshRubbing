...
- Cutline/Outline/Digital Rubbing 결과는 expected record ID 집합을 선언한 session update로 publish되지만, command 입력·계산의 소유권을 MainWindow/viewport에서 application command로 옮기는 작업은 아직 남아 있다.
