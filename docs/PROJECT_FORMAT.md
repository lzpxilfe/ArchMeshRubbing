...
## 양각 음영 record `measurement.relief_shade.v1`

양각 문양은 선이 아니다. 청자 접시의 연판문처럼 벽에서 도드라진 문양은 점을 무수히 찍어 양감을 살린다 — 빛에서 돌아서는 자리는 촘촘하게, 빛을 받는 자리는 비워서. 이 record는 그 점이 따르는 **음영**만 읽는다; 점을 어떻게 찍을지는 도판의 일이고 도판의 축척에서 정해진다.
